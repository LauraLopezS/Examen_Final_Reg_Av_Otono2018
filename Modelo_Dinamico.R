...
#-Defining data-
data_dinam <- list("n"=n,"m"=m,"y"=datos_train$WTI, "x"=select(datos_train, -WTI))

#-Defining inits-
inits<-function(){list(alpha=rep(0,n),beta=matrix(0,k,n),tau.y=1,tau.a=1,tau.b=rep(1,k),yp=rep(1,n),yf=rep(1,m))}
